...
const ProductCard = (props) => {
    return <ProductCardElement>
        ...
        <ProductDetailsContainer>
            ...
            <ProductPrice>
                <CurrencySymbol>$</CurrencySymbol>{props.product.cost}
            </ProductPrice>
            <ProductCardButton onClick={props.showDetails}>
                Show More
            </ProductCardButton>
            { props.showDeleteButton ?
                <ProductCardButton secondary left onClick={props.deleteProduct}>
                  Delete
                </ProductCardButton> : ''}
        </ProductDetailsContainer>
    </ProductCardElement>
