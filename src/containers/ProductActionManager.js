...
class ProductActionManager extends Component {
  ...
  handleBlur(e) {
      if (validatableFields.includes(e.target.name) &&
          ...
          <ProductActionFormContent>
                  ...
                  <GenderBlock>
                      {Object.values(Gender).map((gender) => (
                          <span key={gender}>
                              ...
                              <RadioButtonLabel htmlFor={`product-${gender}`}>
                                  {gender}
                              </RadioButtonLabel>
                            </span>
                      ))}
              ...
              <BlockContainer>
                  <Block>
                      ...
                      {this.state.imagePathInvalid &&
                          this.state.touched.image &&
                          !error.image ? <ErrorMessage>
                              Image path invalid
                          </ErrorMessage> : ''}
                      <BlockInput name='image'
                                  onKeyUp={this.handleChange.bind(this)}
                                  onBlur={this.handleBlur.bind(this)}
                                  defaultValue={product.image}/>
                      {this.state.product.image &&
                          !this.state.imagePathInvalid ?
                          <ImagePreview src={this.state.product.image}/> : ''}
                  </Block>
                  <Block>
                      <BlockTitle>Price:</BlockTitle>
                          {shouldMarkError('cost') ?
                              <ErrorMessage>{error.cost}</ErrorMessage> : ''}
                      <BlockInput name='cost'
                                  onKeyUp={this.handleChange.bind(this)}
                                  onBlur={this.handleBlur.bind(this)}
